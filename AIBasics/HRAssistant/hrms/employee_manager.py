...
if __name__ == "__main__":
    em = EmployeeManager()
    em.add_employee(EmployeeCreate(emp_id=em.get_next_emp_id(), name ="PalH", manager_id=None))
    em.add_employee(EmployeeCreate(emp_id= em.get_next_emp_id(), name="MamaTech", manager_id="E001"))
    em.search_employee_by_name("MamaTech")
