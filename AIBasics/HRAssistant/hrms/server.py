...
from schemas import LeaveApplyRequest, MeetingCreate, MeetingCancelRequest
...
def onboard_new_employee(employee_name: str, manager_name: str):
    ...
    - Send a welcome email to the employee with their login credentials. (Format: employee_name@yahoo.com)
...
@mcp.prompt("org_onboard_new_employee")
def onboard_new_employee_org(employee_name: str, manager_name: str):
    return f"""Onboard a new employee with the following details:
    - Name: {employee_name}
    - Manager Name: {manager_name}
    Steps to follow:
